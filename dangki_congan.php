        ...
        <div class="content-wrapper">
            ...
            $numberphone = mysqli_real_escape_string($conn, $_POST['numberphone']);
              ...
              }else
              {
                ...
                $sql = "INSERT INTO congan(ma, hoten,gioi_tinh,tuoi,diachi,sdt,image,idTV) VALUES (
                    '$ma','$name',$gender,$old,'$address','$numberphone','$target_file',$id_tv)";
                                ...
                                <div class="row">
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="address" class="form-control" placeholder="Nhập Địa chỉ" required="true">
                                        </div>
                                    </div>
                                    <div class="col-xs-6">
                                        <div class="form-group">
