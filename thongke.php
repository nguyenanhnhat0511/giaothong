 ...
 <?php include 'sidebar-admin.php'; ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Lọc biên bảng theo thời gian </h1>
    </section>
    <section >
      ...
      <div class ="row">
        <button class="btn btn-primary btn-lg" type="submit" name="submit" >Lọc</button>
          ...
          <div class="box">
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                $sql = "SELECT * FROM bienban WHERE Thoigianlap >= '$ngaybatdau' AND Thoigianlap <='$ngayketthuc'";
